...
global.mongodb = process.env.MONGODB || "mongodb+srv://fantox001:economycluster@cluster0.ft3cidd.mongodb.net/?retryWrites=true&w=majority";
global.sessionId = process.env.SESSION_ID || "anu0";
global.prefa = process.env.PREFIX || ".";
global.tenorApiKey =
  process.env.TENOR_API_KEY || "AIzaSyCyouca1_KKy4W_MG1xsPzuku5oa8W358c";
global.packname = process.env.PACKNAME || `Atlas MD`;
global.author = process.env.AUTHOR || "FantoX";
